...
int client::Connect( ) 
{
	...
	rc = getsockopt( clientsock, SOL_SOCKET, SO_SNDBUF,(char*) &theTCPWin, (socklen_t*)&len );
	//printf("client send buff:%d \n",theTCPWin);
	rc = getsockopt( clientsock, SOL_SOCKET, SO_RCVBUF,(char*) &theTCPWin, (socklen_t*)&len );
...
int client::write_UDP_FIN( ) 
{
	...
	socklen_t tmpaddlen = sizeof( iperf_sockaddr );
